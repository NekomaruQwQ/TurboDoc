...
import type { CrateData, RustProviderContext } from "./index";
import { deleteCrate, RUST_PROVIDER_HOME_URL } from "./crate-delete";

/** Build a provider context whose navigation requests can be asserted without
...
describe("deleteCrate", () => {
    test("navigates home before deleting the viewed docs.rs crate", () => {
        ...
        expect(navigations).toEqual([RUST_PROVIDER_HOME_URL]);
    });
